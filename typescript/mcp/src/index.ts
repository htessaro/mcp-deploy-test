...
import { Cats, RequestConfig } from 'cats';
...
server.tool(
  ...
  withDefaultParams(
    async (args: { params?: ImagesListSearchOrRandomParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.images.imagesListSearchOrRandom(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { params?: GetImagesBkIEhN3pGParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.images.getImagesBkIEhN3pG(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(async (args: { params: GetImagesParams; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.images.getImages(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { body?: any; params: CreateImagesUploadParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.images.createImagesUpload(args.body || {}, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.images.deleteImagesByImageId(args.imageId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.images.getImagesByImageIdBreeds(args.imageId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.images.createImagesByImageIdBreeds(
          args.imageId,
          args.body || {},
          args.params,
          args.requestConfig,
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.images.deleteImagesByImageIdBreedsByBreedId(
          args.imageId,
          args.breedId,
          args.params,
          args.requestConfig,
...
server.tool(
  ...
  withDefaultParams(async (args: { params: GetBreedsParams; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.breeds.getBreeds(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.breeds.getBreedsByBreedId(args.breedId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(async (args: { params?: GetBreedsSearchParams; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.breeds.getBreedsSearch(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.facts.getBreedsByBreedIdFacts(args.breedId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(async (args: { requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.facts.getFacts(args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(async (args: { params: GetFavouritesParams; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.favourites.getFavourites(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { body?: any; params: CreateFavouritesParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.favourites.createFavourites(args.body || {}, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.favourites.getFavouritesByFavouriteId(
          args.favouriteId,
          args.params,
          args.requestConfig,
        );
...
server.tool(
  ...
  withDefaultParams(
    async (args: {
      ...
      try {
        const { data } = await cats.favourites.deleteFavouritesByFavouriteId(
          args.favouriteId,
          args.params,
          args.requestConfig,
        );
...
server.tool(
  ...
  withDefaultParams(async (args: { params: GetVotesParams; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.votes.getVotes(args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { body?: any; params: CreateVotesParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.votes.createVotes(args.body || {}, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { voteId: string; params: GetVotesByVoteIdParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.votes.getVotesByVoteId(args.voteId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(
    async (args: { voteId: string; params: DeleteVoteByVoteIdParams; requestConfig?: RequestConfig }): Promise<any> => {
      try {
        const { data } = await cats.votes.deleteVoteByVoteId(args.voteId, args.params, args.requestConfig);
...
server.tool(
  ...
  withDefaultParams(async (args: { body?: any; requestConfig?: RequestConfig }): Promise<any> => {
    try {
      const { data } = await cats.webhooks.createWebhooks(args.body || {}, args.requestConfig);
